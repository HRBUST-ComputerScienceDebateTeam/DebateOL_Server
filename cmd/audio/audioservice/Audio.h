...
class AudioProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  AudioProcessor(::std::shared_ptr<AudioIf> iface) :
    iface_(iface) {
...
class AudioProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  AudioProcessorFactory(const ::std::shared_ptr< AudioIfFactory >& handlerFactory) noexcept :
  ...
  AudioConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
  ...
  AudioConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
