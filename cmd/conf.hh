...
enum AC_Level_uu { level_never_uu = 0, level_self_uu = 1, level_friend_uu = 3, level_follow_uu = 6, level_stranger_uu = 9, level_black_uu = 12 };

enum AC_Level_ur { level_never_ur = 0, level_root_ur = 1, level_inroom_ur = 3, level_notinroom_ur = 4, level_black_ur = 9 };
// Access level -- ur
//  enum Jwt_Level_ur{
//      level_self     =  0,
//      level_friend   =  1,
