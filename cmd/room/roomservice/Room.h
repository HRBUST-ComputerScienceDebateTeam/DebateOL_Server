...
class RoomProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  RoomProcessor(::std::shared_ptr<RoomIf> iface) :
    iface_(iface) {
...
class RoomProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  RoomProcessorFactory(const ::std::shared_ptr< RoomIfFactory >& handlerFactory) noexcept :
  ...
  RoomConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
  ...
  RoomConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocol(iprot,oprot);
  }
 private:
