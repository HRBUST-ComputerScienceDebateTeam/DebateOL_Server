...
void Room_GetBaseInfo_SendInfo::printTo( std::ostream& out ) const {
    ...
    out << ", "
        << "jwt_token=" << to_string( jwt_token );
    out << ", "
        << "sendtime=" << to_string( sendtime );
    out << ", "
        << "Aim_Roomnum=" << to_string( Aim_Roomnum );
    out << ", "
        << "info=" << to_string( info );
    out << ")";
}
...
void Room_GetURrelation_RecvInfo::printTo( std::ostream& out ) const {
    ...
    out << ", "
        << "status=" << to_string( status );
    out << ", "
        << "info_UR_pos=" << to_string( info_UR_pos );
    out << ", "
        << "info_UR_per=" << to_string( info_UR_per );
    out << ")";
}
...
void Room_Create_SendInfo::printTo( std::ostream& out ) const {
    ...
    out << ", "
        << "sendtime=" << to_string( sendtime );
    out << ", "
        << "Roomnum=" << to_string( Roomnum );
    out << ", "
        << "Islocking=" << to_string( Islocking );
    out << ", "
        << "Roomname=" << to_string( Roomname );
    out << ", "
        << "passwd=" << to_string( passwd );
    out << ", "
        << "Debate_pos=" << to_string( Debate_pos );
    out << ")";
}
...
void Room_ChangePasswd_SendInfo::printTo( std::ostream& out ) const {
    ...
    out << ", "
        << "roomnum=" << to_string( roomnum );
    out << ", "
        << "Opasswd=" << to_string( Opasswd );
    out << ", "
        << "Npasswd=" << to_string( Npasswd );
    out << ")";
}
