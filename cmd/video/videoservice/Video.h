...
public:
    VideoProcessor( ::std::shared_ptr< VideoIf > iface ) : iface_( iface ) {
...
public:
    VideoProcessorFactory( const ::std::shared_ptr< VideoIfFactory >& handlerFactory ) noexcept : handlerFactory_( handlerFactory ) {}
...
public:
    ...
    VideoConcurrentClient( std::shared_ptr< ::apache::thrift::protocol::TProtocol > iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol > oprot,
