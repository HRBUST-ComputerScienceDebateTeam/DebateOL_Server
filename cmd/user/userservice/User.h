...
public:
    UserProcessor( ::std::shared_ptr< UserIf > iface ) : iface_( iface ) {
...
public:
    UserProcessorFactory( const ::std::shared_ptr< UserIfFactory >& handlerFactory ) noexcept : handlerFactory_( handlerFactory ) {}
...
public:
    ...
    UserConcurrentClient( std::shared_ptr< ::apache::thrift::protocol::TProtocol > iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol > oprot,
